...
async def send_trial_notification(
    ...
    try:
        ...
        logger.error('Failed to send trial notification', error=e)
...
async def send_purchase_notification(
    ...
    try:
        ...
        logger.error('Failed to send purchase notification', error=e)
...
async def send_extension_notification(
    ...
    try:
        ...
        logger.error('Failed to send extension notification', error=e)
